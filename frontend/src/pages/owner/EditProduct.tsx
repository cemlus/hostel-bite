...
export default function EditProduct() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.patch(ENDPOINTS.PRODUCTS.DETAIL(id!), productData);
  ...
  return (
    <div className="container-wide py-8">
      ...
      <div className="max-w-xl">
        <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-8">Edit Product</h1>
